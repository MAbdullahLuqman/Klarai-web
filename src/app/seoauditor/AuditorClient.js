...
function AuditorCore() {
  ...
  return (
    <div className="bg-gray-50 text-gray-900 font-sans selection:bg-[#008dd8] selection:text-white min-h-screen flex flex-col">
      <div className="hide-on-print"><GlobalHeader /></div>

export const servicePageContent = {
  aeo: {
    meta: {
      title: "Answer Engine Optimisation Services UK | Klarai",
      description:
        "AEO services that get your business cited by ChatGPT, Gemini, Perplexity and Google AI Overviews. UK based, founder led, no lock in. Run a free AI visibility audit.",
    },
    hero: {
      visible: true,
    ...
    tldr: {
      ...
      h2: "TL;DR",
      text:
        "AEO, or Answer Engine Optimisation, structures your content so AI engines like ChatGPT, Gemini, Perplexity and Google AI Overviews quote your business directly when customers ask a question. It is not a replacement for SEO, it builds on the same foundations. Klarai audits how AI currently describes your brand, rewrites your priority pages into clear quotable answers, and builds the authority signals that make engines trust you as a source. Start with a free audit to see exactly where you appear in AI answers today.",
    },
    problem: {
      visible: true,
      h2: "The problem, and how we solve it",
      paras: [
        "Your customers have changed how they search, and most websites have not caught up. Instead of scrolling a page of blue links, people now ask ChatGPT or read Google's AI Overview and act on the single answer they are given. Around a third of UK Google searches already return an AI generated answer, and that share grows every month. If the answer names a competitor and never mentions you, you have lost the customer before they even knew you existed.",
        "The hard part is that being on page one is no longer enough. An AI engine can rank your page highly and still quote someone else, because your content is not structured in a way it can lift and trust. That is the gap AEO closes.",
        "Klarai makes your business the source these engines pull from. We restructure your key pages into clear, self contained answers, mark them up with the right schema, strengthen the entity signals that tell Google and the LLMs who you are, and make sure your claims are backed by the kind of authority that earns a citation. When an AI assembles a response in your category, it reaches for your words.",
      ],
    },
    definition: { visible: false },
    included: {
      visible: true,
      h2: "Why work with Klarai on AEO",
      items:
        "Citation focused, not vanity focused: We optimise for the places decisions actually happen now, AI answer boxes, featured snippets, People Also Ask, and voice results. Rankings still matter, but a citation in an AI answer is what wins the click in 2026.\nBuilt on real SEO foundations: AEO without technical SEO is decoration. An engine cannot cite a page it cannot crawl or understand. We fix indexing, site structure and schema first, then layer the answer engineering on top.\nQuotable answer blocks: Every important question on your site gets a tight, factual answer of roughly 40 to 80 words, written so an engine can lift it cleanly without distortion. This is the single highest leverage change most sites are missing.\nEntity and authority building: We strengthen how you are understood across the wider web, through consistent business information, structured data, and credible references, not just edits on your own domain.\nHonest measurement: We track how AI platforms describe and cite your brand over time, so you see real movement instead of vague promises.",
    },
    audience: {
      visible: true,
      h2: "Who this is for",
      text:
        "UK service businesses and brands that want to be found in AI search before their competitors are. That ranges from local trades like plumbers and garages, to professional services like solicitors and accountants, to tech and SaaS brands whose buyers now research entirely through AI. If your customers ask AI before they ask anyone else, you need AEO.",
    },
    process: {
      visible: true,
      h2: "How it works",
      steps:
        "Audit: We examine how AI engines currently represent your brand, which questions in your market they answer, and who they cite instead of you. You get a clear picture of the gaps.\nStructure: We rewrite your priority pages into clear, citable answers, with logical headings, supporting detail, and the schema that helps engines parse them.\nAuthorise: We build the entity and authority signals, consistent business data, structured markup, and credible references, that make engines treat you as a trustworthy source.\nTrack and refine: We monitor your citations across platforms and refine month on month, expanding into new questions as you win the first ones.",
    },
    engagement: {
      visible: true,
      h2: "Engagement models",
      text:
        "We do not sell one size fits all packages, because no two sites start in the same place. Most AEO work runs either as a one off optimisation of your core pages, or as an ongoing monthly retainer that compounds your visibility as authority builds. There is no lock in. Run a free audit and we will recommend the lightest engagement that gets you the result, not the biggest one we can sell.",
    },
    ...
    results: {
      ...
      author: "",
      text:
        "We are founder led by Abdullah Luqman, who builds the same systems Klarai sells rather than outsourcing them. Our featured project is Pitchside AI, a UK grassroots football platform, where we built the full search and answer engine foundation ahead of launch so the site was structured to be found and cited from day one.",
    ...
    faq: {
      ...
      qas:
        "What is the difference between AEO and SEO?|SEO ranks your page in traditional search results. AEO structures your content so AI engines cite it directly inside their answers. You need both, because AI answers are grounded in the same search index that powers normal results, so strong SEO is what makes AEO possible.\nWhat is the difference between AEO and GEO?|AEO focuses on winning direct answers in tools like Google AI Overviews and featured snippets. GEO, or Generative Engine Optimisation, is the broader goal of appearing across all generative platforms including ChatGPT, Perplexity, Gemini and Copilot. In practice they overlap heavily and we treat them as one connected discipline.\nHow long does AEO take to work?|Pages you already rank near the top for can start appearing in AI answers within a few weeks. Newer or more competitive topics usually take two to three months as your authority and citations build.\nDo I need new content, or can you optimise what I already have?|Usually both. We optimise your existing core pages first because that is the fastest win, then fill the question gaps that AI engines are answering in your market but you do not yet cover.\nIs AEO just SEO with a new name?|The foundations overlap, but the answer formatting, schema work and entity building are specific and additional. If an agency's AEO service looks identical to its old SEO service, you are paying for the label, not the work.",
    },
    cta: {
      visible: true,
      h2: "Ready to see how AI describes your business?",
      text:
  ...
  seo: {
    meta: {
      title: "SEO Services UK | Technical and Local SEO | Klarai",
      description:
        "SEO services that fix your foundations and target the terms you are closest to winning first. Technical, on page and local SEO for UK businesses. Free audit, no lock in.",
    },
    hero: {
      visible: true,
      h1: "SEO Services UK",
    ...
    tldr: {
      ...
      h2: "TL;DR",
      text:
        "SEO, or Search Engine Optimisation, makes your website findable by fixing the technical and content foundations that decide whether you rank, then targeting the search terms most likely to bring enquiries. Klarai prioritises the terms you already rank near page one for, so you see movement early, while fixing the architecture, speed, schema and local signals underneath. We work month to month with no lock in. Start with a free audit to see your quickest wins.",
    },
    problem: {
      visible: true,
      h2: "The problem, and how we solve it",
      paras: [
        "Most businesses that struggle with SEO are not lazy, they are publishing pages and seeing nothing move. Usually one of three things is wrong. Google cannot crawl or properly understand the site. The content does not match what people actually type. Or stronger competitors simply have foundations that have not been built yet. In every case, effort without the right structure stays invisible.",
        "The other common mistake is chasing vague head terms like \"plumber\" or \"SEO services\" while ignoring the specific, high intent searches that actually lead to a call or an enquiry. Ranking for a broad word nobody buys from is a vanity metric.",
        "Klarai starts where it counts. We audit your technical health and fix what blocks rankings, then go after the terms you are realistically closest to winning, the ones sitting just off page one, before reaching for harder targets. That sequence gives you momentum in weeks instead of waiting half a year to see anything at all.",
      ],
    },
    definition: { visible: false },
    included: {
      visible: true,
      h2: "Why work with Klarai on SEO",
      items:
        "Fastest wins first: We read your actual Search Console data and prioritise the terms you already rank near page one for. Pushing a term from position eleven to position six produces traffic far faster than starting a brand new topic from zero.\nTechnical foundations done properly: Crawlability, site architecture, internal linking, page speed, canonical tags and schema. These are the unglamorous fixes that quietly decide everything.\nContent that matches intent: We map real search demand to the right pages, so you have a dedicated page for each service and each high intent term, not one overloaded page trying to rank for everything.\nLocal visibility: For businesses that sell to an area, we optimise your Google Business Profile, build consistent citations across UK directories, and work on the Map Pack presence that often matters more than your homepage.\nClear reporting: You see positions, impressions and what changed, explained in plain language, not a dashboard you never open.",
    },
    audience: {
      visible: true,
      h2: "Who this is for",
      text:
        "UK businesses that depend on being found. That includes local service trades such as plumbers, garages and electricians who need to appear when someone searches in their town, and growing brands competing for national terms. If a customer searching right now should find you and currently finds a competitor, this is for you.",
    },
    process: {
      visible: true,
      h2: "How it works",
      steps:
        "Audit: We find what is holding your rankings back, both technically and on the page, and turn it into a prioritised list.\nFix: We clear the blockers, tighten your architecture and internal linking, and get your schema right.\nTarget: We optimise and build the specific pages with the best chance of fast gains, mapped to real high intent keywords.\nGrow: We track results, refine, and expand into more competitive terms as your authority grows.",
    },
    engagement: {
      visible: true,
      h2: "Engagement models",
      text:
        "SEO is an ongoing discipline rather than a one time job, so most clients run a monthly retainer scaled to how competitive their market is. If you are not ready for that, we can start with a one off audit and a fixed list of fixes. We will tell you honestly which one you need. There is no lock in.",
    },
    pricing: { visible: false },
    results: {
      visible: true,
      ...
      author: "",
      text:
        "Klarai is founder led by Abdullah Luqman, who builds and runs the work directly. Our featured project is Pitchside AI, a UK grassroots football platform, where we built the search foundation and content architecture before launch so the site was structured to rank from day one rather than months later.",
      note: "Real client testimonials will be added as they are approved.",
    },
    faq: {
      visible: true,
      h2: "Frequently asked questions",
      qas:
        "How long until I see SEO results?|Terms you already sit just off page one for can move within a few weeks. Competitive new terms typically take two to three months to climb. We always chase the fast wins first so you see progress early.\nWhat is the difference between SEO and local SEO?|General SEO works to rank your pages for searches anywhere. Local SEO focuses on being visible to customers searching within your service area, through your Google Business Profile, local citations and the Map Pack. Most trades and service businesses need local SEO most.\nDo you lock me into a long contract?|No. We work month to month and earn the next month with results.\nHow many keywords should my site target?|There is no single number. The right approach is one focused page for each core service and each high intent term, rather than cramming many keywords onto one page. We map this out for you in the audit based on your real search data.\nWill you tell me honestly if SEO is not right for me?|Yes. The free audit tells you whether SEO will pay back for your business before you spend anything. If it will not, we will say so.",
    },
    cta: {
      visible: true,
  ...
  web: {
    meta: {
      ...
      description:
        "Fast, modern websites engineered to rank from day one and convert visitors into enquiries. SEO and answer engine foundations built in. UK based, you own the site, no lock in.",
    },
    hero: {
      visible: true,
    ...
    tldr: {
      ...
      h2: "TL;DR",
      text:
        "Klarai builds fast, modern websites that are engineered to rank from launch and turn visitors into enquiries, rather than just looking good. Every build has technical SEO and answer engine foundations baked in from the start, clean architecture, schema, speed and clear conversion paths. You fully own the site with no lock in and no proprietary platform. Get a free audit of your current site to see what is holding it back.",
    },
    problem: {
      visible: true,
      h2: "The problem, and how we solve it",
      paras: [
        "Most websites are built to look good and nothing more. They load slowly, they are close to invisible to search engines, and they give visitors no obvious reason to act. A beautiful site that nobody finds and nobody contacts is an expensive brochure sitting in a drawer.",
        "The deeper issue is that design and findability are usually treated as separate jobs. A designer ships something attractive, then SEO is bolted on months later, fighting against decisions that were already baked into the build. By then the structure, the speed and the markup are working against you.",
        "Klarai builds sites the way both search engines and customers reward. We develop fast, cleanly structured websites with SEO and answer engine foundations built in from the first line of code, clear paths that guide visitors toward enquiring, and the technical groundwork that lets the site climb instead of stall. Design and findability are the same job here, not two.",
      ],
    },
    definition: { visible: false },
    included: {
      visible: true,
      h2: "Why work with Klarai on your website",
      items:
        "Built to rank from day one: Clean architecture, correct schema and genuine speed, designed in from the start rather than patched on later.\nFast and modern: We build on current frameworks so the site performs, which helps both your visitors and your rankings.\nConversion focused: Clear structure and calls to action that turn visits into enquiries. Visibility is worthless if the page does not ask for the next step.\nAnswer engine ready: Pages are structured so AI engines can read, understand and cite them, the same foundation our AEO work builds on.\nOwned by you: No lock in, no proprietary platform you cannot leave, no hostage situation. The site is yours.",
    },
    audience: {
      visible: true,
      h2: "Who this is for",
      text:
        "UK businesses that need a website to earn its keep. Whether you are launching something new, rebuilding an ageing site, or replacing one that looks fine but delivers no enquiries, we build for outcomes rather than decoration.",
    },
    process: {
      visible: true,
      h2: "How it works",
      steps:
        "Plan: We map your goals, your audience and the site structure that search engines reward, before any design begins.\nBuild: We develop a fast, modern site with SEO and schema foundations built in from the start.\nOptimise: We tune speed, on page elements and the conversion paths that turn visitors into enquiries.\nLaunch and grow: We ship, then support ranking and refinement after go live, so the site keeps improving.",
    },
    engagement: {
      visible: true,
      h2: "Engagement models",
      text:
        "Web builds are scoped per project based on size and complexity, so you get a clear timeline and scope before anything starts. Many clients pair the build with an ongoing SEO retainer so the site keeps climbing after launch rather than peaking on day one. Share what you need in a free audit and we will scope it honestly.",
    },
    pricing: { visible: false },
    results: {
      visible: true,
      ...
      author: "",
      text:
        "Klarai is founder led by Abdullah Luqman, a developer who builds what he sells rather than handing it off. Our featured project is Pitchside AI, a UK grassroots football platform, built with its search and content foundation in place from the start so it was ready to rank at launch.",
      note: "Real client testimonials will be added as they are approved.",
    },
    faq: {
      visible: true,
      h2: "Frequently asked questions",
      qas:
        "Will my new website actually rank?|A build is a strong foundation, not a guarantee on its own. We engineer the technical SEO into the site so it is rankable from day one, then ongoing SEO does the climbing. A fast, well structured site is far easier to rank than a slow, messy one.\nHow long does a build take?|It depends on the size and complexity of the site, but we scope a clear timeline before we start so there are no surprises.\nDo I own the website?|Yes, fully. There is no lock in and no proprietary platform you cannot move away from.\nCan you redesign my existing site without losing my rankings?|Yes. We migrate carefully, preserving your structure and putting the right redirects in place, so you keep the visibility you have already earned instead of resetting it.\nDo you build the site to be answer engine ready?|Yes. We structure pages so AI engines like ChatGPT and Google AI Overviews can read and cite them, which is the same foundation our AEO work relies on.",
    },
    cta: {
      visible: true,
      h2: "See what your current site is costing you",
      text:
...
export function mergeServicePageContent(serviceId, databasePage = {}) {
  ...
  for (const key of Object.keys(sourcePage)) {
    if (
      sourcePage[key] &&
      databasePage[key] &&
      typeof sourcePage[key] === "object" &&
      !Array.isArray(sourcePage[key]) &&
      typeof databasePage[key] === "object" &&
